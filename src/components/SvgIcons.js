...
const StyledSvg = styled.svg`
  ...
  ${props => props.rotate_ccw_slow && css`animation: ${rotateCounterClockwise} 10s linear infinite;`};
  ${props => props.rotate_ccw_normal && css`animation: ${rotateCounterClockwise} 2.5s linear infinite;`};
  ${props => props.rotate_ccw_fast && css`animation: ${rotateCounterClockwise} 1s linear infinite;`};
`;
...
export const delete_icon = props => {
  return (
    <StyledSvg
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const remove = props => {
  return (
    ...
    >
      ...
      <path
        fill="#fff"
        d="M18.972 16l6.511-6.511c0.156-0.156 0.156-0.41 0-0.566l-2.405-2.406c-0.075-0.075-0.177-0.117-0.283-0.117s-0.208 0.042-0.283 0.117l-6.511 6.511-6.511-6.511c-0.15-0.15-0.416-0.15-0.566 0l-2.406 2.406c-0.156 0.156-0.156 0.41 0 0.566l6.511 6.511-6.511 6.511c-0.156 0.156-0.156 0.41 0 0.566l2.406 2.406c0.075 0.075 0.177 0.117 0.283 0.117s0.208-0.042 0.283-0.117l6.511-6.511 6.511 6.511c0.075 0.075 0.177 0.117 0.283 0.117s0.208-0.042 0.283-0.117l2.406-2.406c0.156-0.156 0.156-0.41 0-0.566l-6.511-6.511z"
      />
    </StyledSvg>
  );
};

export const retunred = props => {
  return (
    <StyledSvg
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
      ...
      {...props}
    >
      <title>retunred</title>
      <path d="M16 32c-8.837 0-16-7.163-16-16s7.163-16 16-16c8.837 0 16 7.163 16 16s-7.163 16-16 16zM19.762 10.504h-7.816l0.645-0.672c0.402-0.419 0.402-1.098 0-1.518s-1.054-0.419-1.457 0l-2.404 2.504c-0 0-0.243 0.254-0.729 0.76l0.728 0.758c0 0 0.859 0.894 2.576 2.683 0.201 0.21 0.465 0.314 0.728 0.314s0.527-0.105 0.729-0.314c0.402-0.419 0.402-1.098 0-1.518l-0.817-0.851h7.816c2.083 0 3.778 1.766 3.778 3.935s-1.695 3.935-3.778 3.935h-10.303c-0.569 0-1.031 0.48-1.031 1.073s0.461 1.073 1.031 1.073h10.303c3.22 0 5.838-2.728 5.838-6.081s-2.619-6.082-5.838-6.082z" />
    </StyledSvg>
  );
};
...
export const warning = props => {
  return (
    ...
    >
      ...
      <path
        fill="#000"
        d="M31.811 27.48l-14.999-24.029c-0.175-0.28-0.483-0.45-0.814-0.45s-0.64 0.171-0.814 0.45l-15.039 24.095c-0.183 0.294-0.193 0.663-0.023 0.965s0.49 0.489 0.837 0.489h30.080c0.533 0 0.962-0.427 0.962-0.952-0.001-0.213-0.071-0.409-0.189-0.568z"
      />
      <path
        fill="#fff"
        d="M14.834 19.394l-0.339-4.627c-0.064-0.902-0.095-1.549-0.095-1.942 0-0.534 0.154-0.951 0.46-1.251 0.307-0.3 0.712-0.45 1.214-0.45 0.608 0 1.014 0.192 1.219 0.575s0.307 0.936 0.307 1.656c0 0.425-0.025 0.857-0.074 1.294l-0.456 4.762c-0.049 0.567-0.155 1.002-0.318 1.305s-0.431 0.453-0.805 0.453c-0.382 0-0.647-0.146-0.794-0.439s-0.255-0.739-0.318-1.338zM16.010 26.112c-0.431 0-0.808-0.143-1.128-0.429s-0.482-0.686-0.482-1.201c0-0.45 0.154-0.832 0.46-1.148s0.684-0.473 1.129-0.473c0.445 0 0.824 0.157 1.139 0.473s0.472 0.698 0.472 1.148c0 0.507-0.159 0.905-0.477 1.195s-0.688 0.434-1.112 0.434z"
      />
    </StyledSvg>
  );
};
