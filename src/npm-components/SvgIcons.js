...
export const warning = props => {
  return (
    ...
    >
      ...
      <path
        fill="#fff"
        d="M14.834 19.394l-0.339-4.627c-0.064-0.902-0.095-1.549-0.095-1.942 0-0.534 0.154-0.951 0.46-1.251s0.712-0.45 1.214-0.45c0.608 0 1.014 0.192 1.219 0.575s0.307 0.936 0.307 1.656c0 0.425-0.025 0.857-0.074 1.294l-0.456 4.762c-0.049 0.567-0.155 1.002-0.318 1.305s-0.431 0.453-0.805 0.453c-0.382 0-0.647-0.146-0.794-0.439s-0.255-0.739-0.318-1.338zM16.010 26.112c-0.431 0-0.808-0.143-1.128-0.429s-0.482-0.686-0.482-1.201c0-0.45 0.154-0.832 0.46-1.148s0.684-0.473 1.129-0.473c0.445 0 0.824 0.157 1.139 0.473s0.472 0.698 0.472 1.148c0 0.507-0.159 0.905-0.477 1.195s-0.688 0.434-1.112 0.434z"
      />
    </StyledSvg>
  );
};
