export default [
  ...
  },
  {
    name: 'inputType',
    type: 'String',
    description: `defines what type the input will be i.e. 'text', 'date', 'number'`
  },
...

  {
    name: 'onChange',
    type: 'Function',
    description: `Used for updating, gives the element, value and propName of the Input component.
