export default [
  {
    name: 'value',
    type: 'String',
    description: `The value of the CheckboxGroup component.`
  },
  {
    name: 'propName',
    type: 'String',
...

  {
    name: 'placeholder',
    type: 'String',
    description: 'Placeholder text for CheckboxGroup.'
  },
...

  {
    name: 'onChange',
    type: 'Function',
    description: `Used for updating, gives the element, value and propName of the CheckboxGroup component.
...

  {
    name: 'checkboxWidth',
    type: 'String',
    description: 'Defines width of the checkboxes'
  },
  {
    name: 'checkboxClassName',
    type: 'String',
    description: 'Classname that applies to each checkbox.'
  }
]